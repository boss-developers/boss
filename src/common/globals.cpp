...
BOSS_COMMON const std::uint32_t BOSS_VERSION_PATCH = 2;
...
BOSS_COMMON const std::uint32_t OBLIVION           = 1;
BOSS_COMMON const std::uint32_t NEHRIM             = 2;
BOSS_COMMON const std::uint32_t SKYRIM             = 3;
BOSS_COMMON const std::uint32_t FALLOUT3           = 4;
BOSS_COMMON const std::uint32_t FALLOUTNV          = 5;

// BOSS Log formatting values.
BOSS_COMMON const std::uint32_t HTML               = 0;
BOSS_COMMON const std::uint32_t PLAINTEXT          = 1;

// Language values.
BOSS_COMMON const std::uint32_t ENGLISH            = 0;
BOSS_COMMON const std::uint32_t SPANISH            = 1;
BOSS_COMMON const std::uint32_t GERMAN             = 2;
BOSS_COMMON const std::uint32_t RUSSIAN            = 3;
BOSS_COMMON const std::uint32_t SIMPCHINESE        = 4;
