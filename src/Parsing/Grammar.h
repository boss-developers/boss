...
private:
	...
	void EvaluateConditional(bool& result, const string type,
	                         const bool condition);

	// Evaluate the second half of a complex conditional.
	void EvaluateCompoundConditional(bool& lhsCondition, const string andOr,
	...
	void CheckVersion(bool& result, const string file, const string version,
